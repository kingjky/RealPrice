<template>
  <div>
    <StoreCard v-for="store in stores2" v-bind:key="store.id" v-bind:srcUrl="store.srcUrl" v-bind:storeName="store.storeName" v-bind:price="store.price" v-bind:percent="store.percent"/>
  </div>
</template>
